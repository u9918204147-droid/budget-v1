...
export default function App() {
  ...
  return (
    <div data-theme={theme} className="min-h-screen w-full font-sans transition-colors duration-300" style={{ background: "var(--bg)", color: "var(--ink)" }}>
      {/* ---------------- Header ---------------- */}
      <header className="sticky top-0 z-20 backdrop-blur border-b" style={{ borderColor: "var(--line)", background: "color-mix(in srgb, var(--bg) 85%, transparent)" }}>
      ...
      <footer className="max-w-6xl mx-auto px-4 sm:px-6 pb-8 pt-2 text-xs text-[color:var(--ink-soft)] text-center">
      ...
      <button
        ...
        className="fixed bottom-5 right-5 sm:bottom-7 sm:right-7 z-30 w-14 h-14 rounded-full flex items-center justify-center text-white transition hover:scale-105 active:scale-95"
